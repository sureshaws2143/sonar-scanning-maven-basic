...
stage("publish to nexus") 
{
  ...
  //nexusArtifactUploader artifacts: [[artifactId: 'sonarscanner-maven-basic', classifier: '', file: 'target/sonarscanner-maven-basic-1.0-SNAPSHOT.jar', type: 'jar']], credentialsId: 'nexus-connect', groupId: 'org.sonarqube', nexusUrl: '192.168.1.160', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-releases', version: '4.0'
  ...
  nexusArtifactUploader artifacts: [[artifactId: 'sonarscanner-maven-basic', classifier: '', file: 'target/sonarscanner-maven-basic-1.0-SNAPSHOT.jar', type: 'jar']], credentialsId: 'root-user-nexusConnect2', groupId: 'org.sonarqube', nexusUrl: '192.168.1.160:8090', nexusVersion: 'nexus3', protocol: 'http', repository: 'maven-releases', version: '1.0-${env.BUILD_NUMBER}'
